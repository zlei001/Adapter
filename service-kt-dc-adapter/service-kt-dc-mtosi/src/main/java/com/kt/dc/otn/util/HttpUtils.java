...
import com.kt.dc.otn.client.exception.HttpRequestException;
...
public class HttpUtils {
     ...
     * @throws Exception Exception
     */
    public static String request(HttpRequestBody requestBody) throws Exception {
    ...
    private static void setConfig(HttpRequestBase httpRequestBase, HttpRequestBody requestBody) {
        ...
        int defaultConnectTimeout = Integer.parseInt("30");
        int defaultSocketTimeout = Integer.parseInt("120");
